...
<div class="content" id="payment">
    <span class="error" id="twocheckoutAPI_error" style="display:none"><?php echo $text_cc_error; ?></span>
    <form id="co-payment-form">
        <input id="sellerId" type="hidden" maxlength="16" width="20" value=<?php echo $twocheckoutAPI_sid; ?>>
        <input id="token" name="token" type="hidden" width="10" value="">
        <input id="publishableKey" type="hidden" maxlength="16" width="20" value=<?php echo $twocheckoutAPI_public_key; ?>>
    <table class="form">
        <tr>
...
<script type="text/javascript">
    function successCallback(data) {
        ...
        if(data.exception != null || (data.validationErrors != null && data.validationErrors.length > 0)){
            ...
            $.ajax({
                url: 'index.php?route=payment/twocheckoutAPI/send',
                type: 'get',
